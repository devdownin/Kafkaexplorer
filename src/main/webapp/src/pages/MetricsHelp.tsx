      ...
      <header className="mb-10 flex flex-wrap items-end justify-between gap-4">
        <div>
          ...
          <h1 className="text-2xl md:text-3xl font-semibold tracking-tight text-on-surface mb-2">
            Aide aux Métriques <span className="text-on-surface-variant font-normal">· Module Kafka SQL</span>
          </h1>
        ...
        <Button variant="secondary" icon="arrow_back" onClick={() => navigate('/metrics')}>Retour aux Métriques</Button>
      </header>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <section className="lg:col-span-4 row-span-2 bg-surface-container-high border border-outline-variant/60 p-6 rounded-xl flex flex-col">
          ...
          <div className="space-y-6 flex-1">
            <div className="p-4 bg-surface-container border-l-2 border-success/50">
              ...
              <p className="text-[10px] text-on-surface-variant">Ratio succès/échec du moteur de règles.</p>
            </div>
            <div className="p-4 bg-surface-container border-l-2 border-warning/50">
              ...
              <p className="text-[10px] text-on-surface-variant">Temps de scrape Prometheus Actuator.</p>
            </div>
            <div className="p-4 bg-surface-container border-l-2 border-error/50">
              ...
              <p className="text-[10px] text-on-surface-variant">Messages rejetés pour non-conformité SQL.</p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
              <div className="p-4 bg-surface-container rounded-xl border border-outline-variant">
                ...
                <p className="text-[10px] text-on-surface-variant">Compare le débit entre deux topics pour détecter une perte de messages.</p>
              </div>
              <div className="p-4 bg-surface-container rounded-xl border border-outline-variant">
                <h4 className="text-[11px] font-bold text-primary tracking-widest uppercase mb-1">TOPIC_TRANSIT_LATENCY</h4>
                <p className="text-[10px] text-on-surface-variant">Mesure le délai (ms) entre l'ingestion Topic A et la sortie Topic B.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="lg:col-span-12 p-8 bg-surface-container-high border border-outline-variant/60 rounded-xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-surface-container/50 p-6 rounded-xl border border-outline-variant hover:border-primary/40 transition-all">
              ...
              <p className="text-[11px] text-on-surface-variant leading-relaxed mb-4">Valeur instantanée pouvant augmenter ou diminuer (stocks, files).</p>
            ...
            <div className="bg-surface-container/50 p-6 rounded-xl border border-outline-variant hover:border-primary/40 transition-all">
              ...
              <p className="text-[11px] text-on-surface-variant leading-relaxed mb-4">Valeur cumulative monotone. Recommence à zéro au redémarrage.</p>
            ...
            <div className="bg-surface-container/50 p-6 rounded-xl border border-outline-variant hover:border-primary/40 transition-all">
              ...
              <p className="text-[11px] text-on-surface-variant leading-relaxed mb-4">Calcule des quantiles sur une fenêtre glissante.</p>
            ...
            <div className="bg-surface-container/50 p-6 rounded-xl border border-outline-variant hover:border-primary/40 transition-all">
              ...
              <p className="text-[11px] text-on-surface-variant leading-relaxed mb-4">Mesure la durée d'événements et le débit associé.</p>
            ...
            <ul className="space-y-4">
              <li className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-on-surface-variant leading-relaxed">Obligatoire pour la colonne principale de données numériques.</p>
                </div>
              </li>
              <li className="flex gap-4">
                <span className="material-symbols-outlined text-primary text-[20px]">check_circle</span>
                <div>
                  ...
                  <p className="text-[11px] text-on-surface-variant leading-relaxed">Une limite de sécurité (100k messages) est appliquée par intervalle.</p>
                </div>
              </li>
            </ul>
          </div>
        ...
        <section className="lg:col-span-12 p-8 bg-surface-container border border-primary/20 rounded-xl">
          <div className="text-center mb-12">
            <h2 className="text-2xl font-black text-on-surfaceer mb-2">Guide de Déploiement</h2>
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-4">
            <div className="flex flex-col items-center text-center max-w-[200px] relative">
              ...
              <p className="text-[10px] text-on-surface-variant leading-tight">Menu Monitoring &gt; Kafka Metrics. Cliquez sur "Ajouter".</p>
            ...
            <div className="flex flex-col items-center text-center max-w-[200px] relative">
              ...
              <p className="text-[10px] text-on-surface-variant leading-tight">Choisissez RAW_SQL et rédigez votre requête d'agrégation.</p>
              <div className="hidden lg:block absolute -right-full top-6 w-full border-t-2 border-dashed border-primary/20"></div>
            </div>
            <div className="flex flex-col items-center text-center max-w-[200px] relative">
              ...
              <p className="text-[10px] text-on-surface-variant leading-tight">Vérifiez les résultats instantanés et fixez les seuils SLA.</p>
              <div className="hidden lg:block absolute -right-full top-6 w-full border-t-2 border-dashed border-primary/20"></div>
            </div>
            <div className="flex flex-col items-center text-center max-w-[200px]">
              ...
              <p className="text-[10px] text-on-surface-variant leading-tight">Exposez la métrique sur l'endpoint Prometheus global.</p>
            </div>
          </div>
        </section>
        ...
        <section className="lg:col-span-12 p-8 border border-error/20 bg-error/5 rounded-lg">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              ...
              <p className="text-[11px] text-on-surface-variant leading-relaxed">Vérifiez vos filtres WHERE et assurez-vous que les topics contiennent des données sur la fenêtre de scan.</p>
            </div>
            <div>
              <span className="font-bold block text-error text-[12px] uppercase tracking-wider mb-2">"Pending Status"</span>
              <p className="text-[11px] text-on-surface-variant leading-relaxed">Le processeur SQL est en attente de ressources. Augmentez l'intervalle si la requête est lourde.</p>
            </div>
            <div>
              <span className="font-bold block text-error text-[12px] uppercase tracking-wider mb-2">Latency Units</span>
              <p className="text-[11px] text-on-surface-variant leading-relaxed">Les métriques de temps doivent être normalisées en millisecondes pour l'agrégation Grafana native.</p>
            </div>
          </div>
        </section>
      </div>
      ...
      <footer className="mt-16 flex flex-col md:flex-row justify-between items-center gap-6 border-t border-outline-variant/60 pt-8">
        <div className="flex gap-4">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[10px] font-bold text-on-surface-variant uppercase tracking-widest">État Global : Opérationnel</span>
          </div>
          <div className="flex items-center gap-2">
        ...
        <div className="flex gap-8 items-center">
          <span className="text-[10px] text-on-surface-variant uppercase font-mono">Mise à jour : {new Date().toISOString().replace('T', ' ').substring(0, 19)} UTC</span>
          <div className="flex gap-4">
