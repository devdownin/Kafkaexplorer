...
> **`v1.7.1` through `v1.9.11` were filed after the fact.** Nothing closed `[Unreleased]` when a
> release went out — `release.yml` tags, builds and publishes, but never touches this file — so
> thirty releases accumulated into one section that said none of them had shipped. Each entry was
> assigned to the **first tag whose `CHANGELOG.md` contained it**, which is exact here rather than
> a reading: comparing the section across all thirty tags shows entries were only ever appended,
> never reworded or removed, so an entry's first appearance *is* the release that carried it. The
> wording is the author's, unchanged. Releases that added no entry say so and link to their notes;
> that is the state of this file, not a gap in the release.
...
Released from `main` with no entry recorded here; see [the release notes](https://github.com/devdownin/Kafkaexplorer/releases/tag/v2.1.1).

## [2.1.0] — 2026-09-25

Released from `main` with no entry recorded here; see [the release notes](https://github.com/devdownin/Kafkaexplorer/releases/tag/v2.1.0).
...
Released from `main` with no entry recorded here; see [the release notes](https://github.com/devdownin/Kafkaexplorer/releases/tag/v1.10.2).
...
Released from `main` with no entry recorded here; see [the release notes](https://github.com/devdownin/Kafkaexplorer/releases/tag/v1.9.13).
...
Released from `main` with no entry recorded here; see [the release notes](https://github.com/devdownin/Kafkaexplorer/releases/tag/v1.9.5).

## [1.9.4] — 2026-08-27

Released from `main` with no entry recorded here; see [the release notes](https://github.com/devdownin/Kafkaexplorer/releases/tag/v1.9.4).

## [1.9.3] — 2026-08-26

Released from `main` with no entry recorded here; see [the release notes](https://github.com/devdownin/Kafkaexplorer/releases/tag/v1.9.3).
...
Released from `main` with no entry recorded here; see [the release notes](https://github.com/devdownin/Kafkaexplorer/releases/tag/v1.8.13).

## [1.8.12] — 2026-08-24

Released from `main` with no entry recorded here; see [the release notes](https://github.com/devdownin/Kafkaexplorer/releases/tag/v1.8.12).
...
Released from `main` with no entry recorded here; see [the release notes](https://github.com/devdownin/Kafkaexplorer/releases/tag/v1.8.8).
...
Released from `main` with no entry recorded here; see [the release notes](https://github.com/devdownin/Kafkaexplorer/releases/tag/v1.8.5).
...
Released from `main` with no entry recorded here; see [the release notes](https://github.com/devdownin/Kafkaexplorer/releases/tag/v1.8.3).

## [1.8.2] — 2026-08-18

Released from `main` with no entry recorded here; see [the release notes](https://github.com/devdownin/Kafkaexplorer/releases/tag/v1.8.2).

## [1.8.1] — 2026-08-18

Released from `main` with no entry recorded here; see [the release notes](https://github.com/devdownin/Kafkaexplorer/releases/tag/v1.8.1).

## [1.8.0] — 2026-08-18

Released from `main` with no entry recorded here; see [the release notes](https://github.com/devdownin/Kafkaexplorer/releases/tag/v1.8.0).
...
[Unreleased]: https://github.com/devdownin/Kafkaexplorer/compare/v2.1.1...HEAD
[2.1.1]: https://github.com/devdownin/Kafkaexplorer/compare/v2.1.0...v2.1.1
[2.1.0]: https://github.com/devdownin/Kafkaexplorer/compare/v2.0.4...v2.1.0
...
[1.9.8]: https://github.com/devdownin/Kafkaexplorer/compare/v1.9.7...v1.9.8
[1.9.7]: https://github.com/devdownin/Kafkaexplorer/compare/v1.9.6...v1.9.7
[1.9.6]: https://github.com/devdownin/Kafkaexplorer/compare/v1.9.5...v1.9.6
[1.9.5]: https://github.com/devdownin/Kafkaexplorer/compare/v1.9.4...v1.9.5
[1.9.4]: https://github.com/devdownin/Kafkaexplorer/compare/v1.9.3...v1.9.4
[1.9.3]: https://github.com/devdownin/Kafkaexplorer/compare/v1.9.2...v1.9.3
[1.9.2]: https://github.com/devdownin/Kafkaexplorer/compare/v1.9.1...v1.9.2
[1.9.1]: https://github.com/devdownin/Kafkaexplorer/compare/v1.9.0...v1.9.1
[1.9.0]: https://github.com/devdownin/Kafkaexplorer/compare/v1.8.13...v1.9.0
[1.8.13]: https://github.com/devdownin/Kafkaexplorer/compare/v1.8.12...v1.8.13
[1.8.12]: https://github.com/devdownin/Kafkaexplorer/compare/v1.8.11...v1.8.12
[1.8.11]: https://github.com/devdownin/Kafkaexplorer/compare/v1.8.10...v1.8.11
[1.8.10]: https://github.com/devdownin/Kafkaexplorer/compare/v1.8.9...v1.8.10
[1.8.9]: https://github.com/devdownin/Kafkaexplorer/compare/v1.8.8...v1.8.9
[1.8.8]: https://github.com/devdownin/Kafkaexplorer/compare/v1.8.7...v1.8.8
[1.8.7]: https://github.com/devdownin/Kafkaexplorer/compare/v1.8.6...v1.8.7
[1.8.6]: https://github.com/devdownin/Kafkaexplorer/compare/v1.8.5...v1.8.6
[1.8.5]: https://github.com/devdownin/Kafkaexplorer/compare/v1.8.4...v1.8.5
[1.8.4]: https://github.com/devdownin/Kafkaexplorer/compare/v1.8.3...v1.8.4
[1.8.3]: https://github.com/devdownin/Kafkaexplorer/compare/v1.8.2...v1.8.3
[1.8.2]: https://github.com/devdownin/Kafkaexplorer/compare/v1.8.1...v1.8.2
[1.8.1]: https://github.com/devdownin/Kafkaexplorer/compare/v1.8.0...v1.8.1
[1.8.0]: https://github.com/devdownin/Kafkaexplorer/compare/v1.7.4...v1.8.0
[1.7.4]: https://github.com/devdownin/Kafkaexplorer/compare/v1.7.3...v1.7.4
[1.7.3]: https://github.com/devdownin/Kafkaexplorer/compare/v1.7.2...v1.7.3
[1.7.2]: https://github.com/devdownin/Kafkaexplorer/compare/v1.7.1...v1.7.2
[1.7.1]: https://github.com/devdownin/Kafkaexplorer/compare/v1.7.0...v1.7.1
