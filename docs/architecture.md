...
C4Container
    ...
    System_Boundary(c1, "Kafka SQL Explorer") {
        ...
        Container(spring_app, "Spring Boot Application", "Java 25, Spring Boot 3.5", "Handles business logic, security, and integration.")
        Container(flink_engine, "Embedded Flink Engine", "Apache Flink 1.18", "Executes SQL queries against Kafka topics.")
    }
